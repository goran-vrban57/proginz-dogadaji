const routes = [
  {
    ...
    children: [
      ...
      { path: 'objavedetalji', component: () => import('pages/objave_detalji.vue') },
      ...
      { path: 'dodajobjavu', component: () => import('pages/admin_objava_dodavanje.vue'), meta: { requiresAdmin: true } },
      { name: 'adminobjavadetalji', path: 'adminobjavadetalji/:id', component: () => import('pages/admin_objava_detalji.vue'), meta: { requiresAdmin: true } },
